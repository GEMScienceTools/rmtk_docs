...
%
% Authors:
% 	Chiara Casotto	- GEM Model Facility, Pavia, Italy
...
\noindent
   ...
   Casotto, C., Silva, V., Rao, A. (2015) 
   OpenQuake Risk Modeller's Toolkit - User Guide. 
   \textit{Global Earthquake Model (GEM). Technical Report 2015-07.\\ 
   doi: 10.13117/GEM.OPENQUAKE.MAN.RMTK.1.0/01, 80 pages.} \hfill \\

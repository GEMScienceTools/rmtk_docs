...
\definecolor{darkblue}{RGB}{65,105,225} % Define the blue color used for citation links
...
% Packages for typesetting verbatim text
\usepackage{verbatim}
\usepackage{fancyvrb}
...
% to produce the glossary: makeglossaries rmtk-docs

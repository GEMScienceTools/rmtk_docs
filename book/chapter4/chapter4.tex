...
\label{chap:vulnerability}
    ...
    \input{book/chapter4/input_models/introduction}

		\subsection{Definition of capacity curves}
		\label{subsec:cap_curves}
		\input{book/chapter4/input_models/capacity_curves}

		\subsection{Definition of ground motion records}
		\label{subsec:gmrs}
		\input{book/chapter4/input_models/gmrs}

		\subsection{Definition of damage model}
		\label{subsec:dmg_model}
		\input{book/chapter4/input_models/damage_models}

		\subsection{Consequence model}
		\label{subsec:cons_model}
		\input{book/chapter4/input_models/cons_model}
	...
	\input{book/chapter4/model_generator/introduction}
		...
		\label{subsec:SPBELA}
		\input{book/chapter4/model_generator/SPBELA}
